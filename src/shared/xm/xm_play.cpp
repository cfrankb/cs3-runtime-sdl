...
static float xm_envelope_lerp(xm_envelope_point_t* __restrict__ a, xm_envelope_point_t* __restrict__ b, uint16_t pos) {
...
static void xm_handle_note_and_instrument(xm_context_t* ctx, xm_channel_context_t* ch,
	...
	case 0xE: /* EXy: Extended command */
		...
		case 4: /* E4y: Set vibrato control */
			ch->vibrato_waveform = static_cast<xm_waveform_type_t>(s->effect_param & 3);
		...
		case 7: /* E7y: Set tremolo control */
			ch->tremolo_waveform = static_cast<xm_waveform_type_t>(s->effect_param & 3);
