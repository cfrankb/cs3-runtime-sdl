...
def main():
    ...
    if params.action not in options:
        ...
        vars = [
            ...
            f'PARGS={strip} --preload-file data --emrun -O3 -sWASM=1 -sALLOW_MEMORY_GROWTH -sASYNCIFY -sEXPORTED_RUNTIME_METHODS=ccall,cwrap -sEXPORTED_FUNCTIONS=_mute,_savegame,_main',
