...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 2. Get the AssetManager instance
        AssetManager assetManagerInstance = getAssets(); // or getApplicationContext().getAssets();

        // 3. Pass it to your native C++ code
...
class SDLClipboardHandler implements
    ...
    static {
        System.loadLibrary("main"); // Or your_actual_lib_name without "lib" and ".so"
    }
